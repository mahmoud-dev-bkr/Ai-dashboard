...
@section('content')
    <div class="p-5 md:p-10">
        <h1 class="my-4 text-2xl font-bold text-gray-600">Update Payments Details</h1>
        {!! Form::open(['route' => 'edit_paymentdetails', 'class' => 'form-paymentdetails']) !!}
        <input type="hidden" name="id" value="{{ $paymentdetails->id }}">

        <div class="items-center my-2 input-group">
            <label class="font-bold w-40">Company</label>
        ...
        <div class="items-center my-2 input-group">
            <label class="font-bold w-40">Plan</label>
        ...
        <div class="items-center my-2 input-group">
            <label class="font-bold w-40">Payment Methods</label>
        ...
        <div class="items-center my-2 input-group">
            <label class="font-bold w-40">Payment Date</label>
            <input type="date" value="{{ $paymentdetails->pay_date }}" class="w-full input bg-base-300/50 arabic" name="pay_date" />
        </div>
...
@section('scripts')
    ...
    <script type="module">
        $(document).ready(function() {
            ...
            $(".form-paymentdetails").submit(function(e) {
                // $('#loader').removeClass('hidden')

                e.preventDefault();
                $.ajax({
                    url: "{{ route('edit_paymentdetails') }}",
                    headers: {
                    ...
                    success: function(data) {
                        ...
                        notyf.success(msg);
                        setTimeout(() => {
                            window.location = '/admin/paymentdetails';
                        }, 500);
