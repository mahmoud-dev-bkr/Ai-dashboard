...
@section('content')
    <div class="p-7">
        ...
        <div class="items-center my-2 input-group">
            <input type="text" class="input bg-base-300/50" name="id" value="{{ $plan ->id }}" placeholder="Enter name OF Plan En" hidden/>
        </div>
        <div class="items-center my-2 input-group">
            <label class="w-40">Name (en)</label>
            <input type="text" class="input bg-base-300/50" name="name_en" value="{{ $plan ->name_en }}" placeholder="Enter name OF Plan En"/>
        </div>

        <div class="items-center my-2 input-group">
            <label class="w-40">Name (ar)</label>
            <input type="text" class="input bg-base-300/50" name="name_ar" value="{{ $plan ->name_ar }}" placeholder="Enter name OF Plan Ar"/>
        </div>

        <div class="items-center my-2 input-group">
            <label class="w-40">Cost</label>
            <input type="text" class="input bg-base-300/50" name="coast" value="{{ $plan ->coast  }}" placeholder="Enter Only Number"/>
        </div>
        
        
        <div class="items-center my-2 input-group">
            <label class="w-40">Max Employee</label>
            <input type="text" class="input bg-base-300/50" name="max_employee" value="{{ $plan ->max_emp }}" placeholder="Enter Max Employee"/>
        </div>
        
        <div class="items-center my-2 input-group">
            <label class="w-40">Duration Day</label>
            <input type="text" class="input bg-base-300/50" name="duration_day" value="{{ $plan ->duration_days }}" placeholder="Enter Duration Day"/>
        </div>
