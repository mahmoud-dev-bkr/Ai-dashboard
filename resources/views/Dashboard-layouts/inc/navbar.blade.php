<div class="flex items-center justify-between shadow-lg bg-white/75">
    <div class="flex items-center mx-3">
        ...
        <div class="flex flex-col p-5">
            <h1 class="font-bold text-gray-500 ">display name</h1>
            <p class="text-sm text-gray-300">display role</p>
        </div>
    </div>
    ...
    <div class="dropdown dropdown-end">
        <label tabindex="0" class="m-1 btn btn-lg btn-primary"><i class="fa fa-bars"></i></label>
