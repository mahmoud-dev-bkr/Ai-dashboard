    ...
    Route::group(
      ...
      function () {
        ...
        Route::group(["prefix" => "company"], function () {
          Route::get("/insert", [CompaniesController::class, "inserPage"]);
          Route::get("/", [CompaniesController::class, "companyPage"])->name(
            "indexPage"
          );
        ...
        Route::group(["prefix" => "users"], function () {
          ...
          Route::get("/insert", [UsersController::class, "insertPage"])->name(
            "insertUserPage"
          );
          ...
          Route::post("/update/{id}", [UsersController::class, "update"])->name(
            "updateUser"
          );
          ...
          ////////////////////////////////////////////////////////////////////////////
          Route::post("/insert", [UsersController::class, "createUser"])->name(
            "addNewUser"
          );

          ////////////get users data for the datatable
          Route::get("/data", [UsersController::class, "getUsersData"])->name(
            "getUsersData"
          );
          ///////////////////////////////////////////////
        });
        ...
        Route::group(["prefix" => "alerts"], function () {
          ...
          Route::get("/data", [AlertsController::class, "getalertdata"])->name(
            "getalertdata"
          );
        ...
        Route::group(["prefix" => "roles"], function () {
          ...
          Route::get("/data", [RolesController::class, "getRulesData"])->name(
            "getRulesData"
          );
          // view for creating a new role
          Route::get("/insert", [RolesController::class, "insertPage"])->name(
            "insertRolePage"
          );
          ...
          Route::put("/update/{id}", [RolesController::class, "update"])->name(
            "updateRole"
          );

          Route::post("/insert", [RolesController::class, "createRole"])->name(
            "createRole"
          );
        });
        // end of roles routes
        ...
        Route::group(["prefix" => "terms"], function () {
          ...
          Route::post("/isnert", [TermsController::class, "insert"])->name(
            "insertTerm"
          );
        });
        // end of terms routes
        ...
        Route::group(
          ...
          function () {
            ...
            // DataTable Get  Plans
            Route::get("/data", [PlanController::class, "getPlansData"])->name(
              "getPlansData"
            );
            // Insert A new Plan
            Route::get("/insert", [PlanController::class, "insertPage"])->name(
              "insertPlanPage"
            );

            // Create Post Route A new Plan
            Route::post("/insert", [PlanController::class, "createPlan"])->name(
              "insertPlan"
            );
            // Edit view Plan
            ...
            Route::post("/update", [PlanController::class, "EditPlan"])->name(
              "EditPlan"
            );
          }
        );
        ...
        // logout user
        Route::delete("/logout", [LoginController::class, "sign_out"])->name(
          "logout"
        );
      }
    );
